...
/*
	METHODS:
		...
		public function send ($recipient, $type = 'mail')
		public function getRFC822($recipients, $type = 'mail')
		public function __construct($data, $name, $contentType, iEncoding $encoding)
		public function __construct($filename, $contentType = 'application/octet-stream', $altName = null, $encoding = null)
...
class htmlMimeMail5
{
    ...
    */
    public function __construct()
    {
        ...
        * Set these up
        */
        $this->build_params['html_encoding'] = new Base64Encoding; // QPrintEncoding();
        $this->build_params['text_encoding'] = new Base64Encoding; // SevenBitEncoding();
        ...
        */
        ...
        $this->headers['X-Mailer'] = 'AvantFAX 3';
    }
    ...
    */
    public function setSMTPParams($host = null, $port = null, $helo = null, $auth = null, $user = null, $pass = null)
    {
        ...
        if (!is_null($user)) $this->smtp_params['username'] = $user;
        if (!is_null($pass)) $this->smtp_params['password'] = $pass;
    }
    ...
    public function send ($recipients, $type = 'mail')
    {
        ...
        switch ($type) {
            ...
            case 'smtp':
                ...
                $smtp = new Mail_smtp ($this->smtp_params);
                ...
                // Send it
                if (!$smtp->send ($send_params['recipients'], $send_params['headers'], $send_params['body'])) {
                    $smtp->_error('Error', $this->errors);
                    return false;
                }
                return true;
                break;
...
class fileAttachment extends attachment
{
	...
	* @param string $altName		Alternate filename
    ...
    */
    public function __construct($filename, $contentType = 'application/octet-stream', $altName = null, $encoding = null)
    {
		...
		if (!$altName) {
			$altName = basename($filename);
		}

        parent::__construct(file_get_contents($filename), $altName, $contentType, $encoding);
    }
}
